...
('LOC_PROMOTION_AMPHIBIOUS_DESCRIPTION', 'No [ICON_Strength]Combat Strength penalty when attacking from sea or river. Unaffected by river, embarking, or disembarking [ICON_Movement] Movement costs.{LOC_BR_LABEL}', 'en_US'),

-- Ranged
('LOC_PROMOTION_VOLLEY_DESCRIPTION', '+5 [ICON_Ranged] Ranged Attack Strength vs. land units.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_ARROW_STORM_DESCRIPTION', '+7 [ICON_Ranged] Ranged Attack Strength vs. land and naval units.[NEWLINE]+7 [ICON_Strength]Combat Strength defending vs. land and naval units.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_INCENDIARIES_DESCRIPTION', '+7 [ICON_Ranged] Ranged Attack Strength vs. cities and encampments.{LOC_BR_LABEL}', 'en_US'),

-- Anti-Cavalry
('LOC_PROMOTION_SCHILTRON_DESCRIPTION', '+10 [ICON_Strength]Combat Strength when defending vs. Melee units.{LOC_BR_LABEL}', 'en_US'),
...
('LOC_PROMOTION_BARDING_DESCRIPTION', '+7 [ICON_Strength]Combat Strength when defending vs. ranged and air attacks (but not siege units or bombers).{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_MARAUDING_DESCRIPTION', '+7 [ICON_Strength]Combat Strength when fighting in a district or attacking a city or encampment.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_ROUT_DESCRIPTION', '+5 [ICON_Strength]Combat Strength when attacking damaged units.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_ARMOR_PIERCING_DESCRIPTION', '+7 [ICON_Strength]Combat Strength vs. Heavy Cavalry units.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_REACTIVE_ARMOR_DESCRIPTION', '+7 [ICON_Strength]Combat Strength when defending vs Heavy Cavalry and Anti-Cavalry units.{LOC_BR_LABEL}', 'en_US'),
...
-- Naval Melee
('LOC_PROMOTION_EMBOLON_DESCRIPTION', '+7 [ICON_Strength]Combat Strength vs. naval units.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_REINFORCED_HULL_DESCRIPTION', '+10 [ICON_Strength]Combat Strength when defending vs. ranged and air attacks (but not siege units or bombers).{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_CONVOY_DESCRIPTION', '+10 [ICON_Strength]Combat Strength when in an Escort Formation.{LOC_BR_LABEL}', 'en_US'),

-- Naval Ranged
('LOC_PROMOTION_ROLLING_BARRAGE_DESCRIPTION', '+10 [ICON_Ranged] Ranged Attack Strength vs. cities and encampments.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_LINE_OF_BATTLE_DESCRIPTION', '+7 [ICON_Ranged] Ranged Attack Strength vs. naval units.{LOC_BR_LABEL}', 'en_US'),
('LOC_PROMOTION_BOMBARDMENT_DESCRIPTION', '+7 [ICON_Ranged] Ranged Attack Strength vs. cities and encampments.{LOC_BR_LABEL}', 'en_US'),
...
-- Air Bombers
('LOC_PROMOTION_BOX_FORMATION_DESCRIPTION', '+7 [ICON_Strength]Combat Strength vs. Air Fighter units.{LOC_BR_LABEL}', 'en_US'),
