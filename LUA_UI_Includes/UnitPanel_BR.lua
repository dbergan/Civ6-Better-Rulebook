...
-- DB
			...
			Controls.BR_TargetDamagePossibilities:SetText(BR_DamagePossibilities(AttStr, DefHealth, WallMaxHealth, WallHealth) .. Locale.Lookup("LOC_BR_LABEL"))
			if combatType == CombatTypes.RANGED or combatType == CombatTypes.BOMBARD then
				Controls.BR_DamagePossibilities:SetText(tostring(AttHealth) .. Locale.Lookup("LOC_BR_LABEL"))
			elseif combatType == CombatTypes.MELEE or combatType == CombatTypes.RELIGIOUS then
				Controls.BR_DamagePossibilities:SetText(BR_DamagePossibilities(DefStr, AttHealth, 0, 0) .. Locale.Lookup("LOC_BR_LABEL"))
			end
-- /DB
		else
...
function BR_DamagePossibilities(Diff, Health, WallMaxHealth, WallHealth)
	local DmgArray = {}
	local Damage = 1
	for a = 24, 35 do
