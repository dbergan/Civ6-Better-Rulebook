				...
				for i,ability in ipairs ( unitAbilitiesList ) do
					...
					if ( abilityDef ~= nil ) then
						if ( abilityDef.Description ~= nil and 
							( zumGrantedAbilities[ abilityDef.UnitAbilityType ] ~= nil or string.find( abilityDef.UnitAbilityType, "GREAT_ADMIRAL" ) or string.find( abilityDef.UnitAbilityType, "GREAT_GENERAL" ) )
							) then
							--abilityText = abilityText .. "[NEWLINE][ICON_Bullet] " .. Locale.Lookup(abilityDef.Description);
							if ( string.find( abilityDef.UnitAbilityType, "GREAT_ADMIRAL" ) or string.find( abilityDef.UnitAbilityType, "GREAT_GENERAL" ) ) then
								isGreatPerson = true;
